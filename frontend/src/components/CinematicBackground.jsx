...
const CinematicBackground = ({ opacity = 'default' }) => {
  ...
  // Determine the CSS class based on the opacity prop
  const getOverlayClass = () => {
    switch (opacity) {
      case 'high':
        return 'cinematic-overlay-high';
      case 'medium':
        return 'cinematic-overlay-medium';
      case 'low':
        return 'cinematic-overlay-low';
      default:
        return 'cinematic-overlay-default';
    }
  };

  return (
    <div className="cinematic-background">
      <div className="cinematic-poster-grid">
        {posters.map((poster, index) => (
          <div
            key={index}
            className="cinematic-poster-item"
            style={{
      ...
      <div className={`cinematic-overlay ${getOverlayClass()}`}></div>
    </div>
  );
};
