...
# Configure CORS
# Get CORS origins from environment variable or use default values
cors_origins_str = os.getenv("CORS_ORIGINS", "http://localhost:5173,http://localhost:3000,http://localhost:5174")
